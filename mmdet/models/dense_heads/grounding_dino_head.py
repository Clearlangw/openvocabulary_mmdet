...
class ContrastiveEmbed(nn.Module):
    ...
    def forward(self, visual_feat: Tensor, text_feat: Tensor,
        ...
        """
        # print("text_feat.shape is",text_feat.shape)
        # print("text_token_mask.shape is",text_token_mask.shape)
        # print("text_token_mask is",text_token_mask)
        # text_feat.shape is torch.Size([2, 27, 256])
        # text_token_mask.shape is torch.Size([2, 27])
        # text_token_mask is tensor([[True, True, True, True, True, True, True, True, True, True, True, True,
