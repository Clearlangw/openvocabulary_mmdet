...
coco_od_dataset = dict(
    ...
    pipeline=[
        ...
        dict(
            ...
            tokenizer_name=
            '/home/wuke_2024/ov202503/text_encoder/bert-base-uncased',
...
lang_model_name = '/home/wuke_2024/ov202503/text_encoder/bert-base-uncased'
launcher = 'none'
load_from = 'grounding_dino_swin-t_pretrain_obj365_goldg_v3det_20231218_095741-e316e297.pth'
log_level = 'INFO'
...
model = dict(
    ...
    language_model=dict(
        ...
        max_tokens=256,
        name='/home/wuke_2024/ov202503/text_encoder/bert-base-uncased',
        pad_to_max=False,
        requires_grad=False,
        shine_inplace_token_num=3,
        shine_prompt_cls_list=[
            'pedestrian',
            'people',
            'bicycle',
            'car',
        ...
        shine_prompt_path=
        '/home/wuke_2024/ov202503/mmdetection/ov_text_feature/shine_class_features',
        special_tokens_list=[
            '[CLS]',
            '[SEP]',
            '.',
...
test_evaluator = dict(
    ann_file='/home/wuke_2024/datasets/original_datasets/shine_diff_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        ann_file='shine_diff_train.json',
