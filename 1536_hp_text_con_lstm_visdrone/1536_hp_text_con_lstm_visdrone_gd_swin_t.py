...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=7,
        with_cp=True),
    background_supp=True,
    background_supp_mode='lstm_gating',
    bbox_head=dict(
...
test_evaluator = dict(
    ann_file='/home/wuke_2024/datasets/original_datasets/val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = '1536_hp_text_con_lstm_visdrone'
