...
model = dict(bbox_head=dict(num_classes=num_classes),use_text_attn_enhance=True,text_attn_enhance_refpath='/home/wuke_2024/ov202503/mmdetection/ov_text_feature/visdrone_concept.pth')
