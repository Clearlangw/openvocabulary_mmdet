...
class_name  = (
    ...
    "truck XX XX", "tricycle XX", "XX XX XX", "bus XX XX", "motor XX XX"
)
...
model = dict(bbox_head=dict(num_classes=num_classes),
            language_model=dict(use_shine=True,
            shine_prompt_path='/home/wuke_2024/ov202503/mmdetection/ov_text_feature/shine_class_features',
            shine_prompt_cls_list=["pedestrian", "people", "bicycle", "car", "van", "truck", "tricycle", "awning-tricycle", "bus", "motor"],
...
val_evaluator = dict(ann_file=data_root + 'shine_diff_val.json')
