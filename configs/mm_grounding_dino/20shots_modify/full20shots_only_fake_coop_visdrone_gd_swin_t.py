...
model = dict(use_fake_coop=True,bbox_head=dict(num_classes=num_classes))
# coop_init="An aerial photograph of a busy urban or park area, one of the objects is"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file='aug-seed-517600-true-few-shot-20-anno.json',
        data_prefix=dict(img='aug-seed-517600-true-few-shot-20-anno/')))
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            # 'language_model.coop.coop_prompt': dict(lr_mult=1),
        }))
