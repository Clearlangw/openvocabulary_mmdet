...
model = dict(backbone=dict(requires_grad=False,finetune_mode='hyperadapter_vl'),bbox_head=dict(num_classes=num_classes),use_seeker_adapter=dino_use_seeker_adapter)
train_pipeline = [
