...
dino_use_text_consistency_loss = True
dino_use_visual_seeker=True
model = dict(backbone=dict(requires_grad=False,finetune_mode='esod_query_seeker',text_dim=256,text_consistency_loss=dino_use_text_consistency_loss,adapter_stages=[2,3]),
            bbox_head=dict(num_classes=num_classes),
            use_seeker_adapter=dino_use_seeker_adapter,use_text_consistency_loss=dino_use_seeker_adapter and dino_use_text_consistency_loss,use_visual_seeker=dino_use_visual_seeker)
train_pipeline = [
