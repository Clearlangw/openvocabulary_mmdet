...
model = dict(backbone=dict(requires_grad=False,finetune_mode='seeker',text_dim=256,text_consistency_loss=dino_use_text_consistency_loss,tokens_of_interest=[0]),
