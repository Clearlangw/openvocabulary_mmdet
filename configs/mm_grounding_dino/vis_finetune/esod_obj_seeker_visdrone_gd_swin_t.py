...
model = dict(backbone=dict(requires_grad=False,finetune_mode='obj_seeker',esod_loss=dino_use_esod_loss),
            bbox_head=dict(num_classes=num_classes),
            use_seeker_adapter=dino_use_seeker_adapter,
            #use_text_consistency_loss=dino_use_seeker_adapter and dino_use_text_consistency_loss,
