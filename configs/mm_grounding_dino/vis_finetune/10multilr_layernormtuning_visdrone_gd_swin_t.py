...
model = dict(backbone=dict(requires_grad=False,finetune_mode='norm_tuning'),bbox_head=dict(num_classes=num_classes))
train_pipeline = [
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            ...
            'backbone': dict(lr_mult=10.0),#为了mona的训练,其余参数仍然冻结
