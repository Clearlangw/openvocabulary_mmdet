...
model = dict(backbone=dict(requires_grad=False,finetune_mode='query_seeker',text_dim=256,text_consistency_loss=dino_use_text_consistency_loss,adapter_stages=[3]),
