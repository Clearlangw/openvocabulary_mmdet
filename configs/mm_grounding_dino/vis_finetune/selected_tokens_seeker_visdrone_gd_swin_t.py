...
dino_use_text_consistency_loss = False
model = dict(backbone=dict(requires_grad=False,finetune_mode='seeker',text_dim=256,text_consistency_loss=dino_use_text_consistency_loss,tokens_of_interest=[0,5,16,17,19,20]),
            bbox_head=dict(num_classes=num_classes),
            use_seeker_adapter=dino_use_seeker_adapter,use_text_consistency_loss=dino_use_seeker_adapter and dino_use_text_consistency_loss)
