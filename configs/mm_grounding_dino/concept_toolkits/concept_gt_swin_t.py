...
class_name = ("wheels", "two", "body", "rectangular", "frame", "windows", "handlebars", 
                "four", "rear", "doors", "large", "upright", "seat", "arms", "head", "legs", "roof",
                "windshield", "cargo", "enclosed", "multiple", "mirrors", "white", "open", "pedals", 
                "posture", "torso", "wearing", "area")
