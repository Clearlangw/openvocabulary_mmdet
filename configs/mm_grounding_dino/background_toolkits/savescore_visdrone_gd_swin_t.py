...
custom_imports = dict(
    imports=['mmdet.engine.hooks.savescores_hook'], # 确保路径正确
    allow_failed_imports=False
)
custom_hooks = [
    dict(
        type='SaveScoresHook', # 对应 @HOOKS.register_module() 注册的名字
        # out_dir='/home/wuke_2024/ov202503/mmdetection/hook_epoch_scores', # 【重要】替换为您希望保存分数的目录
...
model = dict(bbox_head=dict(num_classes=num_classes),background_supp=True,background_supp_mode='gating')
